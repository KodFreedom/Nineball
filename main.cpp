...
#define WINDOW_NAME "ビリヤード　Very Simple版"//ウインドウの名前

//--------------------------------------------------------------------------------
//  関数ポインタ
//--------------------------------------------------------------------------------
typedef void(*ModeFunc)(void);
ModeFunc g_pInitFunc[] = { InitTitle,InitSample,InitGame,InitEnding,InitResult };
ModeFunc g_pUninitFunc[] = { UninitTitle,UninitSample,UninitGame,UninitEnding,UninitResult };
ModeFunc g_pUpdateFunc[] = { UpdateTitle,UpdateSample,UpdateGame,UpdateEnding,UpdateResult };
ModeFunc g_pDrawFunc[] = { DrawTitle,DrawSample,DrawGame,DrawEnding,DrawResult };
